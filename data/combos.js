export const combos = [
  {
    ...
    theme: "comfort",
    idealFor:
      "Unwinding after long days, self-care Sundays, and thoughtful gifting.",
    // featuredImage:
    //   'https://images.unsplash.com/photo-1511988617509-a57c8a288659?auto=format&fit=crop&w=1400&q=80',
    featuredImage: "/images/comfort-box.png",
  ...
  },
  {
    ...
    price: "₹1099",
    tagline:
      "Curated sparks for intimate conversations and memorable date nights.",
    theme: "romantic",
    idealFor:
      "Anniversaries, surprise date setups, or meaningful first celebrations.",
    // featuredImage:
    //   "https://images.unsplash.com/photo-1518895949257-7621c3c786d7?auto=format&fit=crop&w=1400&q=80",
    featuredImage: "/images/romantic-box.png",
    purchaseUrl: "https://www.amazon.in/",
    items: [
      {
  ...
  },
  {
    ...
    price: "₹999",
    tagline:
      "A bright little party kit to make every birthday feel extra special.",
    theme: "birthday",
    idealFor:
      "Best-friend birthdays, sibling surprises, and long-distance celebrations.",
    // featuredImage:
    //   "https://images.unsplash.com/photo-1464349153735-7db50ed83c84?auto=format&fit=crop&w=1400&q=80",
    featuredImage: "/images/birthday-box.png",
    purchaseUrl: "https://www.amazon.in/",
    items: [
      {
  ...
  },
  {
    ...
    price: "₹1199",
    tagline:
      "Elevate your workspace with essentials that keep focus and flow in sync.",
    theme: "desk",
    idealFor:
      "Students, creators, and professionals building a productive routine.",
    // featuredImage:
    //   "https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?auto=format&fit=crop&w=1400&q=80",
    featuredImage: "/images/desk-box.png",
    purchaseUrl: "https://www.amazon.in/",
    items: [
      {
...
export const comboBySlug = Object.fromEntries(
