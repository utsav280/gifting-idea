const packagingImages = {
  ...
  // ]
  comfort: [
    "/images/comfort-box.png",
    "/images/comfort-box.png",
    "/images/comfort-box.png",
  ],
  romantic: [
    "/images/romantic-box.png",
    "/images/romantic-box.png",
    "/images/romantic-box.png",
  ],
  birthday: [
    "/images/birthday-box.png",
    "/images/birthday-box.png",
    "/images/birthday-box.png",
  ],
  desk: [
...
const contentBySlug = {
  comfort: {
    ...
    occasions: [
      {
        title: "After long workdays",
        description:
          "A transition ritual from screen fatigue to grounded calm.",
      },
      {
        title: "Sunday self-care",
        description: "A gentle routine for slow mornings and mindful evenings.",
      },
      {
        title: "Thoughtful support gift",
        description: "Perfect for someone who needs a warm, restorative pause.",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Yes. It is designed for quick decompression and intentional downtime.",
      },
      {
        question: "Will it feel useful beyond one day?",
        answer:
          "Absolutely. The items are selected for repeat comfort rituals, not one-time novelty.",
      },
      {
        question: "Is it suitable for gifting colleagues?",
        answer:
          "Yes. The tone is premium, neutral, and universally appreciated.",
      },
      {
        question: "Does it still look premium in delivery?",
        answer:
          "Yes. Every box is quality checked and packed for clean presentation.",
      },
    ],
  },
  romantic: {
    experienceTitle:
      "A warm, intimate moment—ready before the conversation begins.",
    experienceCopy:
    ...
    occasions: [
      {
        ...
        description:
          "Turn a simple evening into a memorable shared experience.",
      },
      {
        title: "Anniversary surprise",
        description:
          "Celebrate thoughtfully with premium touches and emotional detail.",
      },
      {
        title: "Long-distance reunion",
        description: "Create an instant atmosphere when finally meeting again.",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Not at all. It is intimate and tasteful, not loud or overdone.",
      },
      {
        question: "Can this work for first anniversaries?",
        answer:
          "Yes. It is crafted for meaningful milestones both small and big.",
      },
      {
        question: "Will the packaging feel gift-ready on arrival?",
        answer:
          "Yes. The unboxing experience is part of the intended emotional impact.",
      },
      {
        question: "Is checkout secure?",
        answer:
          "Yes. Orders are completed on trusted marketplaces with secure payment systems.",
      },
    ],
  },
  birthday: {
    ...
    occasions: [
      {
        title: "Last-minute birthday rescue",
        description:
          "A fast, polished gifting solution that still feels thoughtful.",
      },
      {
        title: "Best friend surprise",
        description:
          "Add instant celebration energy with premium presentation.",
      },
      {
        title: "Office birthday moments",
        description: "Celebrate cleanly and confidently in shared spaces.",
      },
    ],
    faq: [
      {
      ...
      },
      {
        ...
        answer:
          "Definitely. The curation is built around instant celebration impact.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. We verify finish, utility, and presentation before packing.",
      },
    ],
  },
  desk: {
    experienceTitle:
      "A refined desk ritual for clarity, focus, and better flow.",
    experienceCopy:
    ...
    occasions: [
      {
        title: "New role or semester",
        description: "Set up a focused environment from day one.",
      },
      {
        title: "Workspace refresh",
        description: "Upgrade daily essentials without visual clutter.",
      },
      {
        title: "Productivity gift",
        description:
          "A thoughtful pick for creators, students, and professionals.",
      },
    ],
    faq: [
      {
        ...
        answer:
          "Yes. It is curated to improve day-to-day desk comfort and focus.",
      },
      {
