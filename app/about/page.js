    ...
    <LayoutShell>
      <article className="space-y-10 py-8">
        ...
        <section className="rounded-3xl border border-black/5 bg-[color:var(--surface)] p-7">
          ...
          <p className="mt-3 text-[color:var(--muted)]">
            We&apos;re building Giftly one thoughtful box at a time. Our promise
            is simple: every combo should look elevated, feel intentional, and
            be easy to purchase from trusted platforms.
          </p>
        </section>
      </article>
    </LayoutShell>
